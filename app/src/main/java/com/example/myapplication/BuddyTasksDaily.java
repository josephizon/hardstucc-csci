        ...
        if (user == null) {
            ...
            userReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(BuddyTasksDaily.this, "Failed to fetch buddyUid: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private void fetchTasksFromDatabase() {
        if (user != null && databaseReference != null) {
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(BuddyTasksDaily.this, "Failed to fetch tasks: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
